...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.stephenfeather.tigimbal.js')
	...
	f = os.path.join(cwd,'Classes','ComStephenfeatherTigimbalModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.stephenfeather.tigimbal.js']
